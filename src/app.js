...
Ammo().then((Ammo) => {
  ...
  function createBillboardRotated(
    ...
    const billboardPoleScale = { x: 15, y: 2.5, z: 1.5 };
  ...
  function createWallX(x, y, z) {
    const wallScale = { x: 0.125, y: 4, z: 145 };
  ...
  function createWallZ(x, y, z) {
    const wallScale = { x: 330, y: 4, z: 0.125 };
  ...
  function start() {
    ...
    // 这里调整边界
    createWallX(165, 1.75, 0);
    createWallX(-165, 1.75, 0);
    createWallZ(0, 1.75, 38);
    createWallZ(0, 1.75, -72);
    ...
    Words(8, 1, -20);
    // 2022提示文字
    createTextOnPlane(-145, 0.81, 10, inputText.terpSolutionsText, 20, 40);
    createTextOnPlane(-120, 0.81, 10, inputText.bagholderBetsText, 20, 40);
    createTextOnPlane(-95, 0.81, 10, inputText.homeSweetHomeText, 20, 40);
    createTextOnPlane(-70, 0.81, 10, inputText.longText, 20, 40);

    // 2021提示文字
    createTextOnPlane(37.5, 0.81, 10, inputText.long21Text, 20, 40);
    createTextOnPlane(12.5, 0.81, 10, inputText.hu21Text, 20, 40);
    createTextOnPlane(-12.5, 0.81, 10, inputText.que21Text, 20, 40);
    createTextOnPlane(-37.5, 0.81, 10, inputText.wu21Text, 20, 40);

    // 2020提示文字
    createTextOnPlane(145, 0.81, 10, inputText.long20Text, 20, 40);
    createTextOnPlane(120, 0.81, 10, inputText.hu20Text, 20, 40);
    createTextOnPlane(95, 0.81, 10, inputText.que20Text, 20, 40);
    createTextOnPlane(70, 0.81, 10, inputText.wu20Text, 20, 40);

    // 图片贴图
    allSkillsSection(-110, 0.025, -20, 110, 110, boxTexture.allSkills);
    allSkillsSection(0, 0.025, -20, 110, 110, boxTexture.allSkills21);
    allSkillsSection(110, 0.025, -20, 110, 110, boxTexture.allSkills20);
